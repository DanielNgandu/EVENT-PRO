...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@EventPro/core')) :
    typeof define === 'function' && define.amd ? define(['exports', '@EventPro/core'], factory) :
    ...
    ***************************************************************************** */
    ...
    var eventSourceDef = {
        ...
        fetch: function (arg, onSuccess, onFailure) {
            ...
            if (!apiKey) {
                onFailure({
                    message: 'Specify a googleCalendarApiKey. See http://EventPro.io/docs/google_calendar/'
                });
            }
            else {
